    ...
    public partial class AddEgyed : Form
    {
        ...
        public AddEgyed(EgyedController controller, Egyed? egyed = null)
        {
            ...
            if (egyed != null)
            {
                ...
                tomegNumericUpDown2.Value = egyed.Weigh;
                nostenyRadioButton1.Checked = egyed.Gender == "Female" ? true : false;
                himRradioButton1.Checked = egyed.Gender == "Female" ? false : true;
        ...
        private void okButton2_Click(object sender, EventArgs e)
        {
            ...
            decimal tomeg = tomegNumericUpDown2.Value;
            string nem = nostenyRadioButton1.Checked ? "Female" : "Male";
            ...
            if (modification)
                ...
                success = controller.AddEged(egyed);
