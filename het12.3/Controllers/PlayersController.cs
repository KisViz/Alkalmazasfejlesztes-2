...
namespace het12._3.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Position,Retired,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Position,Retired,TeamId")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
